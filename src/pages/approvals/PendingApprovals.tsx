...
export function PendingApprovals() {
  ...
  const filtered = (pending || []).filter((req) => {
    ...
    const staffId = (req as unknown as { employeeStaffId?: string }).employeeStaffId || ""
    return !q
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      <div>
        <h2 style={{ fontSize: "20px", marginBottom: "4px" }}>Pending Approvals</h2>
        <p style={{ fontSize: "13px", color: "var(--text-muted)" }}>
          Department leave requests awaiting your review.
        </p>
      </div>
      <Card>
        <div style={{ position: "relative", marginBottom: "16px" }}>
          ...
          <input
            ...
            placeholder="Search by employee, staff ID, leave type, or reference..."
        ...
        {isLoading ? (
          ...
          <div style={{ textAlign: "center", padding: "48px", color: "var(--text-muted)" }}>
            ...
            <div style={{ fontSize: "13px", marginTop: "6px" }}>No pending requests in your department.</div>
          </div>
        ) : (
